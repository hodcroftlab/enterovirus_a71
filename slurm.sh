...
#SBATCH --mem=12G              #Total memory
#Total memory reserved per core: 1GB
...
#SBATCH --output=slurm_output_%j.out      # Standard output (%j = job ID)
...
time snakemake all --cores $SLURM_CPUS_PER_TASK
