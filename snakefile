...
rule blast:
    input: 
        ...
        seqs_to_blast = rules.update_sequences.output.sequences  # download from NCBI Virus
    output:
...
rule blast_sort:
    input:
        ...
        input_seqs = rules.update_sequences.output.sequences  # download from NCBI Virus
    output:
